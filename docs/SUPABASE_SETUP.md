...
2. Click **New Query**
3. Copy the entire contents of `src/supabase/migrations/20251008043754_initial_load.sql`
...
8. Copy the entire contents of `src/supabase/migrations/20251008053509_currency.sql`
...
13. Copy the entire contents of `src/supabase/migrations/20251008053514_analytics.sql`
...
18. Copy the entire contents of `src/supabase/migrations/20251008062059_equipments.sql`
...
23. Copy the entire contents of `src/supabase/migrations/20251008062059_instruments.sql`
...
bunx supabase link --workdir src/supabase --project-ref your-project-ref

# Push migrations
bunx supabase db push --workdir src/supabase
```
...
1. Go to **SQL Editor** in your Supabase dashboard
2. Click **New Query**
3. Copy the entire contents of `src/supabase/seeds/challenges.sql`
4. Paste and **Run**

**Seed 2 - Achievements:**
5. Click **New Query**
6. Copy the entire contents of `src/supabase/seeds/achievements.sql`
7. Paste and **Run**

**Seed 3 - Equipment:**
8. Click **New Query**
9. Copy the entire contents of `src/supabase/seeds/equipments.sql`
10. Paste and **Run**

**Seed 4 - Instruments:**
11. Click **New Query**
12. Copy the entire contents of `src/supabase/seeds/instruments.sql`
13. Paste and **Run**
